...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginForm.setBackground(new java.awt.Color(204, 204, 204));

        FormLabel.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        FormLabel.setLabelFor(loginForm);
        ...
        loginButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\prosa\\Documents\\3e\\JAVA\\javaproject10_tp\\lib\\icons\\Unlock-icon.png")); // NOI18N
        ...
        cancelButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\prosa\\Documents\\3e\\JAVA\\javaproject10_tp\\lib\\icons\\close-icon.png")); // NOI18N
        ...
        passwordPasswordField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        connectionProgressBar.setBackground(new java.awt.Color(255, 255, 255));
        connectionProgressBar.setFont(new java.awt.Font("Source Code Pro", 1, 14)); // NOI18N
        connectionProgressBar.setForeground(new java.awt.Color(0, 0, 0));
        connectionProgressBar.setToolTipText(""); // NOI18N
        connectionProgressBar.setName(""); // NOI18N
        connectionProgressBar.setNextFocusableComponent(loginButton);
        connectionProgressBar.setStringPainted(true);
        connectionProgressBar.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                connectionProgressBarStateChanged(evt);
            }
        });
            ...
            .addGroup(loginFormLayout.createSequentialGroup()
                .addGroup(loginFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(loginFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(loginFormLayout.createSequentialGroup()
                            .addGap(239, 239, 239)
                            .addComponent(FormLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(loginFormLayout.createSequentialGroup()
                            .addGap(31, 31, 31)
                            .addGroup(loginFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(loginFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(usernameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 431, Short.MAX_VALUE)
        ...
        loginFormLayout.setVerticalGroup(
            loginFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(loginFormLayout.createSequentialGroup()
                .addComponent(FormLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
                ...
                .addComponent(connectionProgressBar, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );

        passwordPasswordField.getAccessibleContext().setAccessibleName("");

        loginImage.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        loginImage.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        loginImage.setIcon(new javax.swing.ImageIcon("C:\\Users\\prosa\\Documents\\3e\\JAVA\\javaproject10_tp\\lib\\icons\\login.png")); // NOI18N
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try {
            ...
            if (dbConnection.login(username, password)) {
                ...
                // Create a Timer that fires every 7000 milliseconds
                ...
                timer.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        connectionProgressBar.setValue(i);
                        connectionProgressBar.setString(i + "%");

                        // If the progress bar is full, stop the Timer and show the success message
                        if (i == 100) {
                            ((Timer) e.getSource()).stop();
                            JOptionPane.showMessageDialog(null, "Connexion success", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void connectionProgressBarStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_connectionProgressBarStateChanged

    }//GEN-LAST:event_connectionProgressBarStateChanged

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        //when progress bar is full, close the window without system.exit(0)
        if (connectionProgressBar.getValue() == 100) {
    ...
    private void passwordPasswordFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_passwordPasswordFieldKeyPressed
        //enter press launch loginButton
